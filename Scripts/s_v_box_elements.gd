...
# I am sincerely sorry to anybody who has to look at this abomination...
# If your life does not depend on it you should just leave now
# It was the first tool i wrote for this project and the code is bad in an uncountable amount of ways
# Here's an ascii knight, he will protect you from that horrid code
